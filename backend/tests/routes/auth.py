...
from api.dependencies.auth import generate_webapp_signature_data, \
...
def test_init_data_generation():
    ...
    query_string = generate_webapp_signature_data(example_data, bot_token)
    print(query_string)
    data = validated_telegram_init_data(query_string, telegram_bot_token=bot_token)
    print("data is", data)
